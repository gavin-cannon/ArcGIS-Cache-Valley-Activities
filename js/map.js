require([
  ...
  // Define the location of the event (longitude, latitude)
  const eventLocation = new Point({
    longitude: -111.80745,
    latitude: 41.77495,
  });
...
var events = [
  {
    ...
    content:
      "Find tickets for Ned LeDoux at Cache County Event Center in Logan on 3/14/2024 at 7:00 PM.",
    price: "$15",
  },
  {
    ...
    content:
      "Join us for a night of extraordinary chocolate, familiar friendly faces, and lively Planned Parenthood spirit in support of PPAU and our Logan Health Center.",
    price: "",
  },
  {
    ...
    content:
      "Cache Valley Summer Kick Off PartyExplore all upcoming kick events in Logan, Utah, find information & tickets for upcoming kick events happening in Logan, Utah.",
    price: "",
  },
  {
    ...
    content:
      "The Simon & Garfunkel Story is touring North America again this year! Using huge projection photos and original film footage, featuring a full live band performing all the hits including ‘Mrs...",
    price: "",
  },
  {
  ...
  },
  {
    ...
    content:
      "Events happening in Logan, Utah on Saturday, 9th March 2024 information about Upcoming events in Logan like parties, concerts, meets,shows, sports, club, reunion, Performance",
    price: "",
  },
];
var outdoorActivities = [
  ...
  },
  {
    ...
    content:
      "Go camp, shoot guns, hike, experience the beautiful serenity of Smithfield Canyon.",
    price: "Free",
  },
  {
  ...
  },
  {
    ...
    content:
      "Come use the playground, play baseball, go on a walk, read a book etc.",
    price: "",
  },
  {
...
var indoorActivities = [
  ...
  },
  {
    ...
    title: "Fun Unlimited",
    content:
      "Enjoy a dank experience browsing books, video games, cards, 45 records etc.",
    price: "",
  },
  {
